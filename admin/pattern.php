        ...
        <div class="row">
            ...
            <div class="card my-4">
                ...
                <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3">Pattern </h6>
                ...
                <div class="table-responsive p-0">
                    ...
                    <thead>
                        ...
                        <th class="text-uppercase text-secondary">Patten Name</th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <button  href="javascript:;" class=" font-weight-bold text-xs btn bg-gradient-primary  edit_category" data-toggle="tooltip" data-original-title="Edit user" data-id="<?=$row_s_user['id']?>"  data-name="<?=$row_s_user['name']?>" data-description="<?=$row_s_user['description']?>" data-file_name ="<?=$row_s_user['image']?>">
                                        Edit
                                    </button>

                                    <!-- <button class="delete_category" data-id="<?=$row_s_user['id']?>" >
                                      Delete
                                    </button> -->
                                </td>
                            </tr>
        ...
        <form action="add_category.php" method="POST" enctype="multipart/form-data">
            <div class="modal-body">
                ...
                <div class="input-group input-group-outline my-3">
                    ...
                    <input type="file" class="form-control" name="image" id="cat_img" required>
                </div>
                <div class="input-group input-group-outline my-3">
                    <label class="form-label">Description</label>
                    <input type="text" class="form-control" id="cat_desc" name="description" required>
                </div>   
