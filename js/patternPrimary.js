    ...
    function updateMeshTextureForMesh(mesh, options = {}) {
        ...
        meshPatternDecals.forEach(decal => {
            if (decal.isFullCoverage) {
                ...
                // 1. Create a full-size canvas for the pattern
                const patternCanvas = document.createElement("canvas");
                patternCanvas.width = canvas.width;
                patternCanvas.height = canvas.height;
                const patternCtx = patternCanvas.getContext("2d");

                // 2. Fill pattern canvas with repeating pattern
                ...
                // 3. Create primary color mask ONCE and reuse
