...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const modelSvgPatterns = {
        'ravishSir2.glb': {
            ...
            // Mesh_1: "assets/ModalPatterns/modal6/StripesFront.svg",
            // Mesh_2: "assets/ModalPatterns/modal6/LowerFront.svg",
            // Mesh_3: "assets/ModalPatterns/modal6/zone1back.svg",
            // Mesh_4: "assets/ModalPatterns/modal6/StripesBack.svg",
            // Mesh_5: "assets/ModalPatterns/modal6/LowerBack.svg",
            // Mesh_6: "assets/ModalPatterns/modal6/SleeveUpperLeft.svg",
            // Mesh_7: "assets/ModalPatterns/modal6/SleeveStripesLeft.svg",
            // Mesh_8: "assets/ModalPatterns/modal6/LowerSleeveLeft.svg",
            // Mesh_9: "assets/ModalPatterns/modal6/SleeveUpperRight.svg",
            // Mesh_10: "assets/ModalPatterns/modal6/SleeveStripesRight.svg",
            // Mesh_11: "assets/ModalPatterns/modal6/LowerSleeveRight.svg",
            ...
            // Plane002: "assets/ModalPatterns/modal6/zone1front.svg",
            // Plane002_4: "assets/ModalPatterns/modal6/LowerFront.svg",
            // Plane002_1: "assets/ModalPatterns/modal6/BodyStripe1.svg",
            // Plane002_5: "assets/ModalPatterns/modal6/zone1back.svg",
            // Plane002_6: "assets/ModalPatterns/modal6/LowerBack.svg",
            // Plane002_7: "assets/ModalPatterns/modal6/SleeveUpperLeft.svg",
            // Plane002_9: "assets/ModalPatterns/modal6/LowerSleeveLeft.svg",
            // Plane002_10: "assets/ModalPatterns/modal6/SleeveUpperRight.svg",
            // Plane002_12: "assets/ModalPatterns/modal6/LowerSleeveRight.svg",
            // Plane002_13: "assets/ModalPatterns/modal6/ShoulderLeftNew.svg",
            // Plane002_14: "assets/ModalPatterns/modal6/ShoulderRightNew.svg",
            // Plane002_2: "assets/ModalPatterns/modal6/BodyStripe2.svg",
            // Plane002_3: "assets/ModalPatterns/modal6/BodyStripe3.svg",
    ...
    const zoneMeshMap = {
        zone1: ["Plane002", "Plane002_5"],
        zone2: ["Plane002_4", "Plane002_6"],
        zone3: ["Plane002_1", "Plane002_2", "Plane002_3"],
        zone4: ["Plane002_7", "Plane002_10"],
        zone5: ["Plane002_9", "Plane002_12"],
        zone6: ["Plane002_13", "Plane002_14"],
    ...
    const zoneColorGroupMap = {
        ...
        zone6: {
            "Plane002_13": "secondary",
            "Plane002_14": "secondary",
        }
    ...
    function blinkSubzoneMeshes(subzone) {
        ...
        model.traverse(child => {
            ...
            if (!meshesToBlink.includes(child.name)) return;

            const originalMaterial = child.material;
            const originalColor = originalMaterial.color.clone();

            const blinkColor = new THREE.Color(0xeeeeee);
            child.material.color.copy(blinkColor);

            if (child.material.emissive) {
                child.material.emissive.set(0x8C2F40);
            }
    ...
    document.querySelectorAll('input[name="zoneRadio"]').forEach((radio) => {
        radio.addEventListener("change", () => {
            ...
            const zone3Radio = document.querySelector('input[value="zone3"]');
            const subCategoryZone3 = document.querySelector('.subCategory.zone3');

            // If zone3 or its subzones are selected
            if (selected === "zone3" || selected.startsWith("stripes")) {
                if (subCategoryZone3) subCategoryZone3.style.display = "grid";
                if (zone3Radio) zone3Radio.disabled = true;

                if (selected === "zone3") {
                    // First blink all meshes from zone3
                    blinkZoneMeshes("zone3");

                    // Then auto-select and blink only stripes1
                    setTimeout(() => {
                        const stripes1 = document.querySelector('input[value="stripes1"]');
                        if (stripes1) stripes1.checked = true;
                        activeZone = "stripes1";
                        blinkSubzoneMeshes("stripes1");
                        applySubzoneColor("stripes1");
                    }, 100);
                    return; // stop here
                }
            } else {
                // If switching away from zone3/subzones
                if (subCategoryZone3) subCategoryZone3.style.display = "none";
                if (zone3Radio) zone3Radio.disabled = false;
            }

            // Handle regular zones
            if (zoneMeshMap[activeZone]) {
                console.log(`✅ Selected Zone: ${activeZone}`);
                blinkZoneMeshes(activeZone);
                updateSvgPatternColors();
            }
            // Handle subzones
            else if (subZoneColorGroupMap[activeZone]) {
                console.log(`🎯 Selected Subzone: ${activeZone}`);
                blinkSubzoneMeshes(activeZone);
    ...
    function updateSvgPatternColors() {
        ...
        model.traverse(child => {
            ...
            child.userData.pattern.currentPrimaryHex = mergedColorMap.primary || "#bc1937";
    ...
    function blinkZoneMeshes(zone) {
        ...
        model.traverse(child => {
            ...
            // Use a highlight material (or just modify color temporarily)
            const blinkColor = new THREE.Color(0xeeeeee); // Yellow highlight
            child.material.color.copy(blinkColor);

            // Optional: Add emissive for extra glow effect
            if (child.material.emissive) {
                child.material.emissive.set(0x8C2F40);
            }
    ...
    function loadDefaultModel() {
        ...
        const defaultModelUrl = "assets/models/ravishSir2.glb";
        ...
        halfSleeves: {
            'ravishSir2.glb': {
                placementMeshes: {
                    ...
                    patternMeshes: ['Mesh', 'Plane002_1', 'Plane002_6', 'Plane002_4',], // Only these will show in pattern form
                    gradientMeshes: ['Mesh', 'Plane002_1', 'Plane002_6', 'Plane002_4',], // Only these will show in gradient form
    ...
    function handleTabChange(activeTab) {
        ...
        switch (activeTab) {
            ...
            case 'numberTab':
                ...
                const numberButtons = meshButtonsContainer.querySelectorAll('.Mesh_3, .Mesh_6, .Mesh_9');
            ...
            case 'nameTab':
                ...
                const nameButton = meshButtonsContainer.querySelector('.Mesh_3');
                if (nameButton) nameButton.style.display = 'block';
                break;

            case 'logoTab':
                // Show Plane003 and Plane003_4 from dynamicImageMeshButtons
                const logoButtons = imageButtonsContainer.querySelectorAll('.Mesh, .Plane002_6, .Plane002_4');
    ...
    const cameraPositions = {
        ...
        back: { x: 0, y: 0, z: -5, angle: Math.PI },
    ...
    const meshImageMap = {
        ...
        "Mesh_6": "images/decalPlacements/LeftSleeveNumber.png",
        "Mesh_9": "images/decalPlacements/RightSleeveNumber.png",

        // For name placement
        "Mesh_3": "images/decalPlacements/BackName.png",

        // For logo placement
        "Plane002_6": "images/decalPlacements/LeftShoulderLogo.png",
        "Plane002_4": "images/decalPlacements/RightShoulderLogo.png",
        "Mesh": "images/decalPlacements/FrontLogo.png",
...
<img src="${meshImageMap[meshName] || 'images/decalPlacements/default.png'}" alt="${displayName}">
    ...
    function populateGradientForm(meshNames) {
        const allowedGradientMeshes = ['Mesh', 'Mesh_3', 'Plane002_6', 'Plane002_4'];
    ...
    function selectMeshFromButton(meshName, decalType = 'text') {
        ...
        if (decalType === 'text' && isReadyToApplyText && pendingText) {
            ...
            if (currentTextMode === "name" && selectedMesh.name == "Mesh_3") {
                meshName = "Mesh_3";
            ...
            } else if (currentTextMode === "number" && selectedMesh.name == "Mesh_3") {
                meshName = "Mesh_3";
                ...
                document.getElementById("fontFamilySelect3").value = fontFamily;
                setViewfront('backAngle');
            } else if (currentTextMode === "number" && selectedMesh.name == "Mesh_9") {
                meshName = "Mesh_9";
            ...
            else if (currentTextMode === "number" && selectedMesh.name == "Mesh_6") {
                meshName = "Mesh_6";
                customPosition = { x: 0.5, y: 0.4 };
                fontSize = 250;
                colornewcust = '#fffff';
