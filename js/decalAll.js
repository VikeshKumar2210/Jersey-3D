...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function handleTabChange(activeTab) {
        ...
        switch (activeTab) {
            ...
            case 'numberTab':
                ...
                const numberButtons = meshButtonsContainer.querySelectorAll('.Mesh_5, .Mesh_7, .Mesh_12');
    ...
    const cameraPositions = {
        front: { x: 0, y: 0, z: 8, angle: 0 },
        back: { x: 0, y: 0, z: -7, angle: Math.PI },
...
<img src="${meshImageMap[meshName] || 'images/decalPlacements/default.png'}" alt="${displayName}">
    ...
    function populateGradientForm(meshNames) {
        const allowedGradientMeshes = ['Mesh', 'Mesh_5', 'Mesh_17', 'Mesh_18'];
    ...
    function selectMeshFromButton(meshName, decalType = 'text') {
        ...
        if (decalType === 'text' && isReadyToApplyText && pendingText) {
            ...
            else if (currentTextMode === "number" && selectedMesh.name == "Mesh_7") {
                meshName = "Mesh_7";
                customPosition = { x: 0.5, y: 0.4 };
                fontSize = 250;
                colornewcust = '#fffff';
