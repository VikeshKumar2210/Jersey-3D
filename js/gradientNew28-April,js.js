document.addEventListener("DOMContentLoaded", function () {
    ...
    function applyGradientToSelectedMesh() {
        ...
        // Update preview
        documdocument.getElementById(`gradientPreview-${selectedMeshName}`).style.background =
    ...
    function updateMeshTextureForMesh(mesh) {
        ...
        // 1. Draw gradient background if exists
        ...
        // 2. Draw patterns (with transparency)
        ...
        // 3. Draw images and texts (existing code remains the same)
        ...
        // ... rest of your existing code for images and texts ...
