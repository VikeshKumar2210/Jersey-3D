...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function handleTabChange(activeTab) {
        ...
        const allButtons = meshButtonsContainer.querySelectorAll('button');
        ...
        switch (activeTab) {
            case 'textTab':
                // Show only Plane003 for text
                const textButton = meshButtonsContainer.querySelector('.Plane003');
                if (textButton) textButton.style.display = 'block';
                break;

            case 'numberTab':
                // Show Plane003_2, Plane003_3, and Plane003_2 for number
                const numberButtons = meshButtonsContainer.querySelectorAll('.Plane003_2, .Plane003_3');
            ...
            case 'nameTab':
                // Show only Plane003 for name
                const nameButton = meshButtonsContainer.querySelector('.Plane003');
                if (nameButton) nameButton.style.display = 'block';
                break;

            case 'logoTab':
                // Show Plane003 and Plane003_4 for logo
                const logoButtons = meshButtonsContainer.querySelectorAll('.Plane003, .Plane003_4');
            ...
            default:
                // For all other tabs, show all buttons
                allButtons.forEach(button => {
                    button.style.display = 'block';
                });
        }
