...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const modelSvgPatterns = {
        'Liberty-Jersey.glb': {
            ...
            Plane003_1: "assets/ModalPatterns/modal6/back.svg",
    ...
    const modelMeshConfigs = {
        ...
        halfSleeves: {
            ...
            'Liberty-Jersey.glb': {
                placementMeshes: {
                    Plane003: { displayName: "Front", uvCorrection: { x: 0, y: 0 } },
                    Plane003_1: { displayName: "Back", uvCorrection: { x: 0, y: 0 } },
                    Plane003_4: { displayName: "Shoulder", uvCorrection: { x: 0, y: -0.2 } },
                    Plane003_3: { displayName: "Right Sleeve", uvCorrection: { x: 0, y: -0.2 } },
                    Plane003_2: { displayName: "Left Sleeve", uvCorrection: { x: 0, y: -0.2 } }
                },
    ...
    document.addEventListener('click', (event) => {
        ...
        // Get all intersects but filter for front-facing only
        const intersects = raycaster.intersectObjects(model.children, true)
            .filter(intersect => isFrontFacing(intersect, camera));
