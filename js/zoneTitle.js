...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll('input[name="zoneRadio"]').forEach((radio) => {
        radio.addEventListener("change", () => {
            ...
            if (parentZone) {
                updateZoneTitle(parentZone, selected); // Zone + subzone
            } else {
                updateZoneTitle(selected); // Just zone
            }
            ...
            for (const [zoneKey, { radio: zoneRadio, subCategoryDiv, defaultSub }] of Object.entries(subzoneMap)) {
                ...
                if (isParentZone || isChildSubzone) {
                    ...
                    if (isParentZone) {
                        ...
                        // ⏳ Delay + auto-select default subzone
                        setTimeout(() => {
            ...
            // 🔁 Handle normal (non-subzone) zone logic
        ...
        // 👇 ADD THIS NEW BLOCK for subzone radios (like stripes1, collar1 etc.)
