document.addEventListener("DOMContentLoaded", function () {
    ...
    function showPatternPreview() {
        ...
        document.getElementById("svgColorPickerContainer").style.display = "none";
    ...
    function customizeSVGColor(svgContent, color) {
        // This will replace all stroke colors in the SVG
        // If your SVG uses fill colors instead, change 'stroke' to 'fill'
        // For more complex SVGs, you might need more sophisticated replacement
