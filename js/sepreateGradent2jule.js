document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateMeshTextureForMesh(mesh) {
        ...
        canvas.width = 1024;
        canvas.height = 1024;
        const ctx = canvas.getContext("2d"); // <-- This is the critical line missing
        ...
        if (mesh.userData.gradient) {
            ...
            if (mesh.userData.pattern) {
                ...
                for (let i = 0; i < data.length; i += 4) {
                    ...
                    // Only keep gradient where original was primary color
                    if (hex.toLowerCase() !== primaryColor) {
                        gradientCtx.globalCompositeOperation = 'destination-out';
                ...
                // For non-SVG meshes, apply full gradient
                ctx.drawImage(gradientCanvas, 0, 0);
            }
        }
