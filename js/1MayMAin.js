document.addEventListener("DOMContentLoaded", function () {
    ...
    function populateImagePlacementButtons() {
        ...
        if (!currentModelType || !modelMeshConfigs[currentModelType]) {
            console.warn("No mesh configuration found for model:", currentModelType);
            return;
        }

        const meshConfig = modelMeshConfigs[currentModelType].placementMeshes;
    ...
    const modelMeshConfigs = {
        ...
        // For fullSleeves model
        fullSleeves: {
            placementMeshes: {
                Plane_2: { displayName: "Front", image: "front.png" },
                Plane_3: { displayName: "Back", image: "back.png" },
                Plane_6: { displayName: "Left Sleeve", image: "sleeve.png" },
                Plane_7: { displayName: "Right Sleeve", image: "sleeve.png" }
            }
        },
        // Add more model configurations as needed
        Design1: {
            placementMeshes: {
                Main_Front: { displayName: "Front", image: "front.png" },
                Main_Back: { displayName: "Back", image: "back.png" },
                Arm_L: { displayName: "Left Sleeve", image: "sleeve.png" },
                Arm_R: { displayName: "Right Sleeve", image: "sleeve.png" }
            }
        }
    };
