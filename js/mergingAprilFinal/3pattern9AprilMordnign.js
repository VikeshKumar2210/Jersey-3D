document.addEventListener("DOMContentLoaded", function () {
    ...
    // Limit zoom
    controls.maxDistance = 205; // Set maximum zoom out distance
    ...
    function removePatternFromPart(part) {
        ...
        // Remove all pattern decals from this mesh (both preview and permanent)
    ...
    function applyTextToSelectedMesh(text, uv) {
        ...
        // UV (0,0) is bottom-left, (1,1) is top-right of the texture
    ...
    document.getElementById('applyTextButton').addEventListener('click', () => {
        ...
        if (inputText) {
            ...
            isReadyToApplyImage = false; // Turn off image mode
            pendingImageFile = null; // Clear any pending image
