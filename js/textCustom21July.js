...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const modelSvgPatterns = {
        'Modal2FullSleeves.glb': {
            ...
            Plane_1: "assets/ModalPatterns/modal6/back.svg",
            ...
            'Modal2FullSleeves.glb': {
                placementMeshes: {
                    Plane: {
                        ...
                        textPosition: { x: 0.5, y: 0.8 } // Custom position for front
                    },
                    Plane_1: {
                        displayName: "Back",
                        uvCorrection: { x: 0, y: 0 },
                        textPosition: { x: 0.5, y: 0.2 } // Custom position for back
                    },
                    Plane_4: {
                        displayName: "Left Sleeve",
                        uvCorrection: { x: 0, y: -0.2 },
                        textPosition: { x: 0.5, y: 0.2 } // Custom position for sleeve
                    },
                    Plane_5: {
    ...
    document.addEventListener('click', (event) => {
        ...
        if (intersects.length > 0) {
            ...
            if (isReadyToPlaceImage && pendingImageFile) {
                ...
                // For mouse clicks, we'll use the clicked position
    ...
    function selectMeshFromButton(meshName, decalType = 'text') {
        ...
        if (modelConfig && modelConfig.placementMeshes && modelConfig.placementMeshes[meshName]) {
            customPosition = modelConfig.placementMeshes[meshName].textPosition || customPosition;
        }
