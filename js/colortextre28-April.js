document.addEventListener("DOMContentLoaded", function () {
        ...
        model.traverse((child) => {
            ...
            if (child.isMesh) {
                ...
                if (colorHex) {
                    ...
                    const gradientTexture = createGradientTexture(colorHex, colorHex); // Use the same color for a solid gradient
    ...
    function loadModel(url, colorMappings, modelType) {
        ...
        function updateMeshColor(selectedMesh, selectedColor) {
            ...
            if (!mesh || !mesh.userData.gradient) return;

            // Update the gradient colors (both to same color makes it solid)
            mesh.userData.gradient.color1 = selectedColor;
            mesh.userData.gradient.color2 = selectedColor;

            // Force update of the texture
