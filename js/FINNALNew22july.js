...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const modelSvgPatterns = {
        'ravishSir.glb': {
            ...
            Plane002_6: "assets/ModalPatterns/modal6/Shoulder.svg",
            Plane002_4: "assets/ModalPatterns/modal6/Shoulder.svg",
    ...
    function applyTextToSelectedMesh(text, uv, overrideFontSize = null, overrideFontFamily = null) {
    ...
    function selectMeshFromButton(meshName, decalType = 'text') {
        ...
        if (decalType === 'text' && isReadyToApplyText && pendingText) {
            ...
            applyTextToSelectedMesh(pendingText, customPosition, fontSize, fontFamily);
            //resetTextPlacementMode();
        }
