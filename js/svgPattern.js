document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateMeshTextureForMesh(mesh) {
        ...
        // 2. Draw SVG pattern if exists (full coverage)
