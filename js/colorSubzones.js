...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll('input[name="zoneRadio"]').forEach((radio) => {
        radio.addEventListener("change", () => {
            ...
            // Loop through all subzone groups and handle show/hide logic
            for (const [zoneKey, { radio: zoneRadio, subCategoryDiv, defaultSub }] of Object.entries(subzoneMap)) {
                if (selected === zoneKey || selected.startsWith(zoneKey.replace("zone", ""))) {
                    // Show subzone container and disable main zone
                    ...
                    // Hide subzone container and re-enable main zone radio
